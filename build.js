...
const headers = `/*
  Content-Security-Policy: default-src 'none'; script-src https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://unpkg.com https://whatever-dev-ws.github.io 'unsafe-eval' 'unsafe-inline' blob:; connect-src https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://unpkg.com https://fonts.googleapis.com data:; img-src data:; font-src https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://unpkg.com https://fonts.gstatic.com; style-src 'unsafe-inline'; worker-src blob:; base-uri 'none'; form-action 'none'; frame-ancestors https://whatever-dev-ws.github.io
